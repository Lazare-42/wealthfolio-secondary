export const QueryKeys = {
  ...
  AI_ARENA_AGENTS: "aiArenaAgents",
  AI_ARENA_CHALLENGES: "aiArenaChallenges",
  AI_ARENA_PARTICIPANTS: "aiArenaParticipants",
  AI_ARENA_LEADERBOARD: "aiArenaLeaderboard",
  AI_ARENA_PORTFOLIO: "aiArenaPortfolio",
  AI_ARENA_RUNS: "aiArenaRuns",
  AI_ARENA_TRADES: "aiArenaTrades",
  AI_ARENA_THESES: "aiArenaTheses",
  aiArenaParticipants: (challengeId: string) => [QueryKeys.AI_ARENA_PARTICIPANTS, challengeId],
  aiArenaLeaderboard: (challengeId: string) => [QueryKeys.AI_ARENA_LEADERBOARD, challengeId],
  aiArenaPortfolio: (participantId: string) => [QueryKeys.AI_ARENA_PORTFOLIO, participantId],
  aiArenaRuns: (challengeId: string) => [QueryKeys.AI_ARENA_RUNS, challengeId],
  aiArenaTrades: (challengeId: string) => [QueryKeys.AI_ARENA_TRADES, challengeId],
  aiArenaTheses: (symbol?: string, challengeId?: string) => [
    QueryKeys.AI_ARENA_THESES,
    symbol ?? "all",
    challengeId ?? "all",
  ],
