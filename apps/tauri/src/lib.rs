...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai_arena::run_due_arena_agents,
            commands::ai_arena::settle_arena_challenge,
            commands::ai_arena::get_arena_leaderboard,
            commands::ai_arena::get_arena_portfolio,
            commands::ai_arena::get_arena_runs,
