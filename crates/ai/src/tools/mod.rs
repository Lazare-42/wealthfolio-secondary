...
pub use wealthfolio_agent_tools::tools::{
    ...
    RecordActivityArgs, RecordActivityOutput, ResolvedAsset, ResolvedAssetDto, SearchActivities,
    SearchActivitiesArgs, SearchActivitiesOutput, SearchMarketSymbols, SearchMarketSymbolsArgs,
